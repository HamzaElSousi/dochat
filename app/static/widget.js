...
(function () {
  ...
  style.textContent = [
    ...
    '}',
    '@keyframes dc-msg-user {',
    '  from { opacity: 0; transform: translateX(10px); }',
    '  to   { opacity: 1; transform: translateX(0); }',
    '}',
    '@keyframes dc-msg-bot {',
    '  from { opacity: 0; transform: translateX(-10px); }',
    '  to   { opacity: 1; transform: translateX(0); }',
    '}',
    ...
    '  box-shadow: 0 2px 8px rgba(0,0,0,0.12), 0 6px 20px rgba(0,0,0,0.12);',
    '  z-index: 2147483647;',
    '  transition: filter 150ms ease, transform 150ms ease;',
    '  animation: dc-fab-in 400ms cubic-bezier(0.34,1.56,0.64,1) 200ms both;',
    '}',
    '#dc-fab:hover  { filter: brightness(0.92); transform: scale(1.06); }',
    '#dc-fab:active { transform: scale(0.96); }',
    '#dc-fab:focus  { outline: 2px solid rgba(255,255,255,0.8); outline-offset: 3px; }',
    ...
    '  box-shadow: 0 4px 6px rgba(0,0,0,0.04), 0 12px 40px rgba(0,0,0,0.15);',
    '  z-index: 2147483647;',
    '  display: flex;',
    ...
    '}',
    '#dc-close:hover { background: rgba(255,255,255,0.28); }',
    '#dc-close:focus { outline: 2px solid rgba(255,255,255,0.6); outline-offset: 2px; }',
    ...
    '#dc-messages::-webkit-scrollbar-thumb { background: #cbd5e1; border-radius: 2px; }',
    ...
    '}',
    '#dc-empty h2 { font-size: 16px; font-weight: 600; margin: 0; }',
    '#dc-empty p  { font-size: 13px; color: #64748b; margin: 0; line-height: 1.5; }',
    ...
    '  align-self: flex-end;',
    '  margin-left: auto;',
    '  animation: dc-msg-user 180ms ease-out both;',
    '}',
    '.dc-bubble-bot {',
    ...
    '  margin-right: auto;',
    '}',
    '.dc-bubble-bot:not(.dc-typing) { animation: dc-msg-bot 180ms ease-out both; }',
    '.dc-bubble-error {',
    '  background: #fef2f2;',
    ...
    '  align-items: center;',
    '  gap: 6px;',
    '  animation: dc-msg-bot 180ms ease-out both;',
    '}',
    ...
    '}',
    '.dc-chip:active { transform: translateY(0); }',
    ...
    '  outline: none;',
    '  overflow-y: hidden;',
    '  max-height: calc(14px * 1.5 * 4 + 20px);',
    '  background: #f8fafc;',
    ...
    '  border-color: var(--dc-primary);',
    '  background: #fff;',
    '  box-shadow: 0 0 0 3px color-mix(in srgb, var(--dc-primary) 12%, transparent);',
    '}',
    '#dc-send {',
    '  width: 44px;',
    '  height: 44px;',
    ...
    '}',
    '#dc-send:not(:disabled):hover  { filter: brightness(0.9); }',
    '#dc-send:not(:disabled):active { transform: scale(0.93); }',
    ...
    '  width: 92%;',
    '  font-size: 14px;',
    '  animation: dc-msg-bot 200ms ease-out both;',
    '}',
    '.dc-lead-form p { margin: 0 0 12px; font-size: 13px; color: #475569; line-height: 1.5; }',
    '.dc-lead-form input {',
    '  width: 100%;',
    '  padding: 9px 12px;',
    '  margin-bottom: 8px;',
    ...
    '  background: #fff;',
    '}',
    '.dc-lead-form input::placeholder { color: #94a3b8; }',
    '.dc-lead-submit {',
    '  width: 100%;',
    '  padding: 10px 16px;',
    '  background: var(--dc-primary);',
    ...
    '  transition: filter 150ms ease, transform 120ms ease;',
    '}',
    '.dc-lead-submit:not(:disabled):hover  { filter: brightness(0.9); }',
    '.dc-lead-submit:not(:disabled):active { transform: scale(0.98); }',
    ...
    '  animation: dc-msg-bot 200ms ease-out both;',
    '}',
    '.dc-thankyou p { margin: 0; font-size: 13px; color: #475569; line-height: 1.5; }',

    /* Reduced motion */
    '@media (prefers-reduced-motion: reduce) {',
    '  #dc-panel, #dc-fab { transition: none; animation: none; }',
    '  .dc-dot { animation: none; }',
    '  .dc-bubble-user, .dc-bubble-bot, .dc-bubble-error, .dc-lead-form, .dc-thankyou { animation: none; }',
    '}',
